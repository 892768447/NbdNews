	...
	protected void onDraw(Canvas canvas) {
		...
		if (tabCount > 0) {
			...
			if (selectionOffset > 0f
				...
				float leftOffset = indicationInterpolator
						.getLeftEdge(selectionOffset);
				float rightOffset = indicationInterpolator
				...
				left = (int) (leftOffset
						* Utils.getLeft(nextTab, indicatorWithoutPadding) + (1.0f - leftOffset)
						* left);
				right = (int) (rightOffset
						* Utils.getRight(nextTab, indicatorWithoutPadding) + (1.0f - rightOffset)
						* right);
